...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "react", "tsparticles-engine", "./Utils"], factory);
    }
    ...
    class Particles extends react_1.Component {
        ...
        shouldComponentUpdate(nextProps) {
            ...
            return (nextProps.url !== this.props.url &&
                ...
                !(0, Utils_1.deepCompare)(nextProps.options ?? nextProps.params, this.props.options && this.props.params));
        }
        componentDidUpdate() {
            this.refresh();
        }
